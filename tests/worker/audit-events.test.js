...
describe('shared audit statement constructor', () => {
  it.each([
    ...
    ['appointment.cancelled', 'appointment', 'apt_cancelled', { appointmentVersion: 2, cancellationReason: 'client', chargeVersion: 1 }],
    ['appointment.restored', 'appointment', 'apt_restored', { appointmentVersion: 3, chargeVersion: 1 }],
