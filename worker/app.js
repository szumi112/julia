...
const CORE_ROUTES = Object.freeze([
  ...
  descriptor({ id: 'specialists.create', path: '/api/v1/specialists', methods: ['POST', 'OPTIONS'], allow: CORE_COMMAND_ALLOW, capability: 'staff.manage', auditActions: ['specialist.profile.created'], bodyKeys: ['displayName', 'professionalTitle', 'standardRateGrosze', 'longRateGrosze', 'specialization', 'avatarKey'] }),
  descriptor({ id: 'specialists.edit', pathPattern: `^/api/v1/specialists/sp_[A-Za-z0-9][A-Za-z0-9_-]{0,124}/edits$`, methods: ['POST', 'OPTIONS'], allow: CORE_COMMAND_ALLOW, capability: 'staff.manage', auditActions: ['specialist.profile.updated'], bodyKeys: ['expectedVersion', 'displayName', 'professionalTitle', 'standardRateGrosze', 'longRateGrosze', 'specialization', 'avatarKey'] }),
  ...
  descriptor({ id: 'clients.create', path: '/api/v1/clients', methods: ['POST', 'OPTIONS'], allow: CORE_COMMAND_ALLOW, capability: 'client.manage', auditActions: ['client.created'], bodyKeys: ['name', 'age', 'status', 'specialistId'], optionalBodyKeys: ['assignmentStartsAt', 'guardianPhone', 'guardianEmail', 'receptionNotes', 'intakeReason', 'guardianClientId', 'secondGuardianClientId', 'parentalRights', 'therapyConsent'] }),
