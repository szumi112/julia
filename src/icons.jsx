...
const PATHS = {
  ...
  ledger: (
    <>
      <path d="M3.5 5.5c2.8-.8 5.6-.5 8.5 1v13c-2.9-1.5-5.7-1.8-8.5-1V5.5z" />
      <path d="M20.5 5.5c-2.8-.8-5.6-.5-8.5 1v13c2.9-1.5 5.7-1.8 8.5-1V5.5z" />
      <path d="M6 9c1.4-.1 2.5.1 3.7.6M6 12.5c1.4-.1 2.5.1 3.7.6M18 9c-1.4-.1-2.5.1-3.7.6M18 12.5c-1.4-.1-2.5.1-3.7.6" />
    </>
  ),
  settings: (
    <>
